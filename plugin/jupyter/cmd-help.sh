...
function _do_jupyter_repo_cmd_help() {
  ...
  case "${sub_cmd}" in
    ...
    install)
      echo "Builds jupyter docker image to local." ;;
    ...
    start)
      echo "Starts the jupyter server.";;

    stop)
      echo "Stops the jupyter server.";;
  esac
}
