...
function _do_gitlab_repo_cmd_help() {
  ...
  case "${sub_cmd}" in
    ...
    install)
      echo "Builds gitlab docker image to local." ;;
    ...
    start)
      echo "Starts the gitlab server.";;

    stop)
      echo "Stops the gitlab server.";;
  esac
}
