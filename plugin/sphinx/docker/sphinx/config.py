...
# Create sample custom variables
PLATFORM_TEXT = """
.. role:: raw-html(raw)
   :format: html
...
class Config(object):
    ...
    config_values = dict(
        ...
        pygments_style=('sphinx', 'html', string_classes),
        ...
        rst_epilog = (PLATFORM_TEXT, 'env', string_classes),
        ...
        # HTML options
        html_theme=('sphinx_rtd_theme', 'html'),
        html_theme_path=(['_static'], 'html'),
        ...
        html_show_sourcelink=(False, 'html'),
        ...
        htmlhelp_basename = ('testdoc', None),
